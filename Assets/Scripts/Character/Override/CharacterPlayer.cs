...
//#endif
    ...
    private void GroundedCheck()
    {
        ...
        if (_hasAnimator)
        {
            _animator.SetBool(AnimationParams.IsGround_Param, Grounded);
        }
    }
    ...
    private void JumpAndGravity()
    {
        if (Grounded)
        {
            ...
            if (_hasAnimator)
            {
                _animator.SetBool(AnimationParams.Jump_Param, false);
                _animator.SetBool(AnimationParams.FreeFall_Param, false);
            }
            ...
            if (_input.jump && _jumpTimeoutDelta <= 0.0f)
            {
                ...
                if (_hasAnimator)
                {
                    _animator.SetBool(AnimationParams.Jump_Param, true);
                }
            }
        ...
        else
        {
            ...
            else
            {
                ...
                if (_hasAnimator)
                {
                    _animator.SetBool(AnimationParams.FreeFall_Param, true);
                }
            }
